...
def move_snake():
    ...
    if snake_direction == "right":
        snake_grid_x[0] = snake_grid_x[0] + 1
    elif snake_direction == "left":
        snake_grid_x[0] = snake_grid_x[0] - 1
    elif snake_direction == "up":
        snake_grid_y[0] = snake_grid_y[0] - 1
...
def grow_snake():
    ...
    last_snake_part_x = snake_grid_x[len(snake_grid_x) -1]
    last_snake_part_y = snake_grid_y[len(snake_grid_y) -1]
    snake_grid_x.append(last_snake_part_x) #append is a function that adds to the end of a list
    snake_grid_y.append(last_snake_part_y)
...
def snake_touching_dot():
    ...
    if dot_grid_y == snake_grid_y[0] and dot_grid_x == snake_grid_x[0]:
        return True
    else:
        return False
...
def snake_hit_wall():
    ...
    if snake_grid_x[0] > 21 or snake_grid_x[0] < 0 or snake_grid_y[0] > 15 or snake_grid_y[0] < 0:
        return True
    else:
        return False
...
def snake_has_died():
    ...
    if snake_hit_wall() or snake_hit_itself():
        return True
    else:
        return False
